---
title: "10_HUVEC and BSA Complex Analysis"
...
R_experiment_name <- "R_HUVEC_BSA_complex" 
...
tom_result_1e6 <- read_csv("230523_AC9_0,1amolTMTpro127BSA_wTrigandHUVEC_Tomahto90min_Result.csv")
tom_result_1e5 <- read_csv("230523_AC9_1amolTMTpro127BSA_wTrigandHUVEC_Tomahto90min_Result.csv")
tom_result_1e4 <- read_csv("230523_AC9_10amolTMTpro127BSA_wTrigandHUVEC_Tomahto90min_Result.csv")
tom_result_1e3 <- read_csv("230523_AC9_100amolTMTpro127BSA_wTrigandHUVEC_Tomahto90min_Result.csv")


####################################DDA PSMs###########################################

dda_1e6 <- read_csv("230523_AC9_0,1amolTMTpro127BSA_wTrigandHUVEC_HCDorb90min_PSM.csv")
dda_1e5 <- read_csv("230523_AC9_1amolTMTpro127BSA_wTrigandHUVEC_HCDorb90min_PSM.csv")
dda_1e4 <- read_csv("230523_AC9_10amolTMTpro127BSA_wTrigandHUVEC_HCDorb90min_PSM.csv")
dda_1e3 <- read_csv("230523_AC9_100amolTMTpro127BSA_wTrigandHUVEC_HCDorb90min_PSM.csv")

########################################DDA TMT Skyline#########################################

dda_tmt_1e6 <- read_csv("BSA_0,1amol_HUVEC_MS1_MS2_DDA_TMTpro_SkylineReport.csv")
dda_tmt_1e5 <- read_csv("BSA_1amol_HUVEC_MS1_MS2_DDA_TMTpro_SkylineReport.csv")
dda_tmt_1e4 <- read_csv("BSA_10amol_HUVEC_MS1_MS2_DDA_TMTpro_SkylineReport.csv")
dda_tmt_1e3 <- read_csv("BSA_100amol_HUVEC_MS1_MS2_DDA_TMTpro_SkylineReport.csv")

########################################DDA shTMT Skyline#######################################

dda_sh_1e6 <- read_csv("BSA_0,1amol_HUVEC_MS1_MS2_DDA_shTMTpro_SkylineReport.csv")
dda_sh_1e5 <- read_csv("BSA_1amol_HUVEC_MS1_MS2_DDA_shTMTpro_SkylineReport.csv")
dda_sh_1e4 <- read_csv("BSA_10amol_HUVEC_MS1_MS2_DDA_shTMTpro_SkylineReport.csv")
dda_sh_1e3 <- read_csv("BSA_100amol_HUVEC_MS1_MS2_DDA_shTMTpro_SkylineReport.csv")

########################################Tomahto TMT Skyline###################################

tom_tmt_1e6 <- read_csv("BSA_0,1amolTarget_HUVEC_MS1_MS2_Tomahto_TMTpro_SkylineReport.csv")
tom_tmt_1e5 <- read_csv("BSA_1amolTarget_HUVEC_MS1_MS2_Tomahto_TMTpro_SkylineReport.csv")
tom_tmt_1e4 <- read_csv("BSA_10amolTarget_HUVEC_MS1_MS2_Tomahto_TMTpro_SkylineReport.csv")
tom_tmt_1e3 <- read_csv("BSA_100amolTarget_HUVEC_MS1_MS2_Tomahto_TMTpro_SkylineReport.csv")

########################################Tomahto shTMT Skyline#################################

tom_sh_1e6 <- read_csv("BSA_0,1amolTarget_HUVEC_MS1_MS2_Tomahto_shTMTpro_SkylineReport.csv")
tom_sh_1e5 <- read_csv("BSA_1amolTarget_HUVEC_MS1_MS2_Tomahto_shTMTpro_SkylineReport.csv")
tom_sh_1e4 <- read_csv("BSA_10amolTarget_HUVEC_MS1_MS2_Tomahto_shTMTpro_SkylineReport.csv")
tom_sh_1e3 <- read_csv("BSA_100amolTarget_HUVEC_MS1_MS2_Tomahto_shTMTpro_SkylineReport.csv")

###############################add source to each file################################
dataframes <- ls(pattern = "_1e[3-6]")
...
dda <- bind_rows(dda_1e3, dda_1e4, dda_1e5, dda_1e6) %>% 
  mutate(Peptide = Sequence) #for ease of comparison

tom <- bind_rows(tom_result_1e3, tom_result_1e4, tom_result_1e5, tom_result_1e6)

#Skyline Reports for DDA and Tomahto for shTMT (triggers) and TMTpro (targets)
dda_sh <- bind_rows(dda_sh_1e3, dda_sh_1e4, dda_sh_1e5, dda_sh_1e5, dda_sh_1e6) 

dda_tmt <- bind_rows(dda_tmt_1e3, dda_tmt_1e4, dda_tmt_1e5, dda_tmt_1e6)

tom_sh <- bind_rows(tom_sh_1e3, tom_sh_1e4, tom_sh_1e5, tom_sh_1e6)

tom_tmt <- bind_rows(tom_tmt_1e3, tom_tmt_1e4, tom_tmt_1e5, tom_tmt_1e6)

rm(dda_1e3, dda_1e4, dda_1e5, dda_1e6, 
   tom_result_1e3, tom_result_1e4, tom_result_1e5, tom_result_1e6,
   dda_sh_1e3, dda_sh_1e4, dda_sh_1e5, dda_sh_1e6,
   dda_tmt_1e3, dda_tmt_1e4, dda_tmt_1e5, dda_tmt_1e6,
   tom_sh_1e3, tom_sh_1e4, tom_sh_1e5, tom_sh_1e6,
   tom_tmt_1e3, tom_tmt_1e4, tom_tmt_1e5, tom_tmt_1e6)

##Jurkat BSA For Comparison #############

jurkat <- read_csv("240304_Jurkat_complex_combined_for_fig.csv")
...
dda_for_fig <- matched_dda_skyline_tmt_distinct %>% 
  ...
  mutate(source = "DDA",
      ...
      grepl("_1e3", exp.x) ~ 100,
      grepl("_1e4", exp.x) ~ 10,
      grepl("_1e5", exp.x) ~ 1,
      grepl("_1e6", exp.x) ~ 0.1,
      TRUE ~ NA_real_))
...
combined_for_fig <- combined_for_fig %>% 
  ...
  select(Peptide, charge, num_detected, total_area_MS1, total_area_MS2, source, target_dilution_amol, source_dilution, id) %>% 
...
plot_bsa_repeatability_peps <- combined_for_fig %>%
  ...
  ggplot(aes(x = source, y = reorder(Peptide, desc(total_times_detected)), color = source_dilution)) +
  geom_point(size= 5) +
...
plot(plot_bsa_repeatability_peps)
...
plot_bsa_repeatability_ids_dilutions <- combined_for_fig %>%
  group_by(Peptide, source_dilution) %>%
  filter(is_lowest_dilution = TRUE) %>% 
  ggplot(aes(x = source, y = reorder(id, desc(total_times_detected)), color = source_dilution)) +
  geom_point(size= 5) +
  scale_color_manual(values = custom_palette) +
  labs(
    title = str_wrap("Repeatability of Tomahto: BSA Tryptic Peptides", width = 60),
...
combined_for_fig %>% 
  filter(!total_area_MS1 > 250000000) %>% 
  group_by(Peptide, source_dilution) %>% 
  slice(1) %>% 
  ungroup() %>% 
  mutate(log10_dilution = log10(target_dilution_amol)) %>% 
...
combined_sh_for_fig <- combined_sh_for_fig %>% 
  mutate(source_dilution = paste(source, target_dilution_amol, sep= ": ")) %>%
  select(Peptide, charge, num_detected, total_area_MS1, total_area_MS2, source, target_dilution_amol, source_dilution, id, Intensity) %>% 
    group_by(Peptide, source) %>% 
  mutate(is_lowest_dilution = target_dilution_amol == min(target_dilution_amol)) %>% 
  ungroup() %>% 
  group_by(Peptide, source) %>%
...
combined_sh_for_fig %>%
  group_by(Peptide, source_dilution) %>%
  ggplot(aes(x = source_dilution, y = reorder(id, desc(total_times_detected)), color = source)) +
    facet_grid(rows = vars(source),
             cols = vars(target_dilution_amol),
             space = "free_y", scales = "fixed") +
  geom_point(size= 5) +
...
combined_sh_for_fig %>%
  group_by(Peptide, source_dilution) %>%
  ggplot(aes(x = source_dilution, y = reorder(id, desc(total_times_detected)), color = source, size = total_area_MS1)) +
    facet_grid(rows = vars(source),
             cols = vars(target_dilution_amol),
             space = "free_y", scales = "fixed") +
  geom_point() +
...
combined_sh_for_fig %>%
  group_by(Peptide, source_dilution) %>%
  ggplot(aes(x = source_dilution, y = reorder(id, desc(total_times_detected)), color = source, size = log(total_area_MS1 +1))) +
    facet_grid(rows = vars(source),
             cols = vars(target_dilution_amol),
             space = "free_y", scales = "fixed") +
  geom_point() +
...
combined_sh_for_fig %>% 
  filter(source == "DDA") %>% 
  group_by(Peptide, target_dilution_amol) %>% 
  slice(1) %>% 
  ungroup() %>% 
...
write_csv(combined_sh_statistics, "240229_shTMTpro_stats_HUVEC_BSA.csv")  
...
write_csv(combined_tmt_statistics, "240229_TMTpro_stats_HUVEC_BSA.csv")  

```

### Combining Jurkat and HUVEC BSA

```{r}
jurkat <- jurkat %>% 
  mutate(cell = "Jurkat") %>% 
  mutate(source = ifelse(str_detect(source, "Tomahto"), "Tomahto HCD", source))

huvec <- combined_for_fig %>% 
  mutate(cell = "HUVEC") %>% 
  mutate(source = ifelse(str_detect(source, "Tomahto"), "Tomahto CID", source))

cid_hcd <- bind_rows(jurkat, huvec)

cid_hcd <- cid_hcd %>%
  mutate(source = ifelse(str_detect(source, "DDA"), "DDA HCD", source)) %>% 
  mutate(source = factor(source, levels = c("DDA HCD", "Tomahto HCD", "Tomahto CID")))

cid_hcd <- cid_hcd %>% 
  filter(!target_dilution_amol == 0.01) %>% 
  mutate(is_lowest_dilution = target_dilution_amol == min(target_dilution_amol))

cid_hcd <- cid_hcd %>% 
  mutate(replicate = ifelse(source == "Tomahto CID", 1, replicate)) 

cid_hcd <- cid_hcd %>% 
  filter(!(source == "DDA HCD" & cell == "HUVEC"))

write_csv(cid_hcd, "240313_Combined_HCD_CID_BSA.csv")

#####################peptide IDs + NO MS1 Intensity######################
plot_bsa_ids_detection_cid_hcd <- cid_hcd %>% 
  group_by(Peptide, source) %>% 
  filter(is_lowest_dilution = TRUE) %>% 
ggplot(aes(x= source, y = reorder(id, desc(total_area_MS1)), color= source)) +
  geom_point(size = 5) +
...
plot_bsa_ids_detection_cid_hcd

#####################peptide full sequence + NO MS1 Intensity######################

plot_bsa_detection_cid_hcd <- cid_hcd %>% 
  group_by(Peptide, source) %>% 
  filter(is_lowest_dilution = TRUE) %>% 
ggplot(aes(x= source, y = reorder(Peptide, desc(total_area_MS1)), color= source)) +
  geom_point(size = 5) +
...
plot_bsa_detection_cid_hcd

#####################peptide full sequence + NO MS1 Intensity######################

plot_bsa_detection_dil_cid_hcd <- cid_hcd %>% 
  filter(!(cell == "HUVEC" & source == "DDA HCD")) %>% 
  group_by(Peptide, source) %>% 
  filter(is_lowest_dilution = TRUE) %>% 
ggplot(aes(x= source, y = reorder(Peptide, desc(total_area_MS1)), color= source_dilution)) +
  geom_point(size = 5) +
  scale_color_manual(values = custom_palette) +
  labs(title = str_wrap("Detection of BSA Peptides in Complex Matrix", width = 60),
       x= "MS Sampling Mode", y = "Peptide", color = str_wrap("amol on Column", width = 15)) +
  theme_minimal() +
...
plot_bsa_detection_dil_cid_hcd
